  ...
  describe "more_paginate" do
    describe "content" do
      it "should provide link with given text" do
        helper.more_paginate(records, :content => "more events").should == %(<a href="?sort_key=id&amp;sort_value=&amp;sort_id=" class="more_link" data-sort-value="" id="more_link">more events</a>)
      end

      it "should escape given text" do
        helper.more_paginate(records, :content => "<script>xss</script>").should == %(<a href="?sort_key=id&amp;sort_value=&amp;sort_id=" class="more_link" data-sort-value="" id="more_link">&lt;script&gt;xss&lt;/script&gt;</a>)
      end

      it "should show text according to the current locale" do
        I18n.backend.store_translations :it, :more => "ancora"
        with_locale :it do
          helper.more_paginate(records).should == %(<a href="?sort_key=id&amp;sort_value=&amp;sort_id=" class="more_link" data-sort-value="" id="more_link">ancora</a>)
        end
      end
    ...
    describe "DOM id" do
      it "should provide default value" do
        helper.more_paginate(records).should == %(<a href="?sort_key=id&amp;sort_value=&amp;sort_id=" class="more_link" data-sort-value="" id="more_link">more</a>)
      end

      it "should use given value" do
        helper.more_paginate(records, :id => "more_paginate").should == %(<a href="?sort_key=id&amp;sort_value=&amp;sort_id=" class="more_link" data-sort-value="" id="more_paginate">more</a>)
      end
    end
    ...
    describe "DOM class" do
      ...
      it "should use given value" do
        helper.more_paginate(records, :class => "more_paginate").should == %(<a href="?sort_key=id&amp;sort_value=&amp;sort_id=" class="more_paginate" data-sort-value="" id="more_link">more</a>)
      end
    end

    describe "path_prefix" do
      it "should use given url prefix" do
        helper.more_paginate(records, :path_prefix => "/timeline").should == %(<a href="/timeline?sort_key=id&amp;sort_value=&amp;sort_id=" class="more_link" data-sort-value="" id="more_link">more</a>)
      end
    end
