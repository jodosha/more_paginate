...
describe ActiveRecord::Associations::HasAndBelongsToManyAssociation do
  describe "paginate" do
    it "return first records by id" do
      ...
      event.people.paginate(:all, :limit => 23 + 1).should == records[0...23]
    end
    ...
    it "return following records with different sort value" do
      ...
      event.people.paginate(:all, :sort_key => "identifier", :limit => 23 + 1).should == records[0...23]
      event.people.paginate(:all, :sort_key => "identifier", :limit => 23 + 1, :sort_value => sort_record.identifier, :sort_id => sort_record.id).should == records[23...30]
    end
