...
describe ActiveRecord::Associations::HasManyThroughAssociation do
  describe "paginate" do
    it "return first records by id" do
      ...
      event.tags.paginate(:all, :limit => 23).should == records[0...23]
    end
    ...
    it "return following records with different sort value" do
      ...
      event.tags.paginate(:all, :sort_key => "identifier", :limit => 23).should == records[0...23]
      event.tags.paginate(:all, :sort_key => "identifier", :limit => 23, :sort_value => sort_record.identifier, :sort_id => sort_record.id).should == records[23...30]
    end
